...
def load_FER2013(transform = grayscale_transform):
    dataset = datasets.FER2013("data", download=True, transform=transform)
...
def load_LSUN(transform = rgb_transform):
    dataset = datasets.LSUN("data", download=True, transform=transform)
